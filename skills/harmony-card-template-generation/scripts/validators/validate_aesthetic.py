        ...
        if "backgroundImage" in styles:
            ...
            if layer_uncertainty:
                ...
                rounded_exposes_parent = (
                    ...
                    and not rounded_layer_contains_subject(
                        ancestor_id,
                        component_id,
                        component,
                        styles,
...
def rounded_layer_contains_subject(
    ancestor_id: str,
    component_id: str,
    component: dict[str, Any],
    styles: dict[str, Any],
) -> bool:
    if ancestor_id == component_id and component.get("component") == "Button":
        return True
    padding = styles.get("padding")
    if numeric(padding) not in (None, 0):
        return True
    if isinstance(padding, dict):
        return any((numeric(value) or 0) > 0 for value in padding.values())
    return False
